...
class ShowGridImageInFullView : AppCompatActivity(), View.OnTouchListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_show_grid_image_in_full_view)
        window.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN)
        imageView=findViewById(R.id.showGridImageInFullViewImageView)
        backBtn=findViewById(R.id.showGridImageInFullViewImageViewBackBtn)
        imageView.setOnTouchListener(this)
        imageView.setImageBitmap(MyDataClass.gridImage)
