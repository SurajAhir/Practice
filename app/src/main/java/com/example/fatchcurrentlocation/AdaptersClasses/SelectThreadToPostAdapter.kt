...
class SelectThreadToPostAdapter(
...
) : RecyclerView.Adapter<SelectThreadToPostAdapter.SelectThreadToPostViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelectThreadToPostViewHolder {
        var view =
    ...
    private fun convertTimeIntoSimpleMinuts(lastActivityDate: Date, holder:SelectThreadToPostViewHolder) {
